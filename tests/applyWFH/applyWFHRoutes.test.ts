...
describe('POST /apply', () => {
  ...
  test('should call requestWorkFromHome if the user is authenticated', async () => {
    ...
    const mockUser: UserPayload = { Staff_ID: 123456, Role: 'Employee', Staff_FName: 'Jerric', Staff_LName: 'Chan', Dept: 'Engineering', Country: 'Singapore', Email: 'Jerric.Chan@allinone.com.sg', Position: 'Director'};
    mockJwtVerify.mockImplementationOnce((token, secret, callback) => {
